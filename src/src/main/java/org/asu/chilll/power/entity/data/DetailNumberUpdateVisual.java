...
@NamedQueries({
	@NamedQuery(
        name = "DetailNumberUpdateVisual.fetchPendingDetailNumberUpdateVisualRecordTotalCount",
        query = "SELECT count(d.childId) FROM DetailNumberUpdateVisual d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade"
    ),
    @NamedQuery(
        name = "DetailNumberUpdateVisual.fetchDetailNumberUpdateVisualListByTimestamp",
        query = "SELECT d FROM DetailNumberUpdateVisual d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade order by d.createTime"
    ),
    @NamedQuery(
        name = "DetailNumberUpdateVisual.fetchDistributedNumberUpdateVisualDetailTotalCount",
        query = "SELECT count(d.uid) FROM DetailNumberUpdateVisual d where d.createTime > :createTime"
    )
})

@Entity
@Table(name = "detail_number_update_visual")
public class DetailNumberUpdateVisual {
	@Id
	private String uid;
