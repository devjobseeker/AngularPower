...
@NamedQueries({
	@NamedQuery(
        name = "DetailVisualSpanRunning.fetchPendingDetailVisualSpanRunningRecordTotalCount",
        query = "SELECT count(d.childId) FROM DetailVisualSpanRunning d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade"
    ),
    @NamedQuery(
        name = "DetailVisualSpanRunning.fetchDetailVisualSpanRunningListByTimestamp",
        query = "SELECT d FROM DetailVisualSpanRunning d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade order by d.createTime"
    ),
    @NamedQuery(
        name = "DetailVisualSpanRunning.fetchDistributedVisualSpanRunningDetailTotalCount",
        query = "SELECT count(d.uid) FROM DetailVisualSpanRunning d where d.createTime > :createTime"
    )
})

@Entity
@Table(name = "detail_visual_span_running")
public class DetailVisualSpanRunning {
	@Id
	private String uid;
