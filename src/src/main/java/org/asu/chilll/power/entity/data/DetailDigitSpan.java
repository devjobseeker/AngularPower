...
@NamedQueries({
    @NamedQuery(
        name = "DetailDigitSpan.fetchPendingDetailDigitSpanRecordTotalCount",
        query = "SELECT count(d.childId) FROM DetailDigitSpan d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade"
    ),
    @NamedQuery(
        name = "DetailDigitSpan.fetchDetailDigitSpanListByTimestamp",
        query = "SELECT d FROM DetailDigitSpan d where d.createTime > :createTime and d.childId = :childId and d.grade = :grade order by d.createTime"
    ),
    @NamedQuery(
        name = "DetailDigitSpan.fetchDistributedDigitSpanDetailTotalCount",
        query = "SELECT count(d.uid) FROM DetailDigitSpan d where d.createTime > :createTime"
    )
})

@Entity
@Table(name = "detail_digit_span")
public class DetailDigitSpan {
	@Id
	private String uid;
